...
from flwr.client.message_handler.task_handler import get_server_message, get_task_message
...
def grpc_request_response(
    ...
    Tuple[Callable[[], Optional[Task]], Callable[[Task], None]]
]:
    ...
    def receive() -> Optional[Task]:
        ...
        print("try receiving next task from server")
        ...
        print("return task_message")
        # Return the Task Message
        return task_message

    def send(task_message_proto: Task) -> None:
        ...
        # Wrap Task message in TaskRes
        task_message_proto.MergeFrom(Task(
